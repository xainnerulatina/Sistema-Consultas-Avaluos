...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4">
				<form class="form-contact">
			       	<div class="input-group">
						...
						<span class="input-group-addon" id="usernameAddon"><i class="fa fa-fw fa-user-circle" aria-hidden="true"></i></span>
						<input type="text" id="inputUsername" class="form-control" placeholder="Nombre completo" required autofocus>
					</div>
				
					<div class="input-group">
					    <label for="inputEmail" class="sr-only">Correo electrónico</label>
						<span class="input-group-addon" id="emailAddon"><i class="fa fa-fw fa-envelope" aria-hidden="true"></i></span>
					    <input type="email" id="inputEmail" class="form-control" placeholder="Correo electrónico" required autofocus>
					</div>

					<div class="input-group">
					    <label for="inputMessage" class="sr-only">Mensaje</label>
						<span class="input-group-addon" id="messageAddon"><i class="fa fa-fw fa-comment" aria-hidden="true"></i></span>
			...
			<div class="col-lg-8">
				<p>¿Tienes alguna consulta con respecto al servicio de consultas o avalúos?</p>
				<p>Utiliza el siguiente formulario para indicarnos tus comentarios o problemas relacionados con el uso del sistema.</p>
			</div>
		</div>
	</div>
