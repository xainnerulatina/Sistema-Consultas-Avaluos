...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-5">
				<img src="img/register/check.jpg" alt="" class="img-responsive img-thumbnail">
			</div>
			<div class="col-lg-7">
				<h1>¡Felicidades!</h1>
				<p>Tu cuenta ya ha sido activada, ya puedes empezar a disfrutar de nuestros servicios.</p>
