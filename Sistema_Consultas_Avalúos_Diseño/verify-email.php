		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-header">
					<h1>Consultas y avalúos</h1>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-5">
				<img src="img/register/email.jpg" alt="" class="img-responsive img-thumbnail">
			</div>
			<div class="col-lg-7">
				<h1>¡Un paso más!</h1>
				<p>Te has registro de manera exitosa, sin embargo, necesitamos que confirmes el correo electrónico de verificación que te hemos enviado, por favor revisa tu bandeja de entrada.</p>
